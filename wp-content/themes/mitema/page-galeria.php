	...
	<section>	
		<ul class="gallery">
		    <li class="gallery-item">
		     	<img class="image" src="assets/img/galeria1.png" alt="">
		    </li>
		    <li class="gallery-item">
			    <img class="image" src="assets/img/galeria2.png" alt="">
			</li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria3.png" alt="">
		  	</li>
		 	<li class="gallery-item">
		    	<img class="image" src="assets/img/galeria4.png" alt="">
		 	</li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria5.png" alt="">
		    </li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria6.png" alt="">
		    </li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria7.png" alt="">
		    </li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria8.png" alt="">
		    </li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria9.png" alt="">
		    </li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria10.png" alt="">
		    </li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria11.png" alt="">
		    </li>
		    <li class="gallery-item">
		    	<img class="image" src="assets/img/galeria12.png" alt="">
		    </li>
		</ul>
